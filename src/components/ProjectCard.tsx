...
export default function ProjectCard({
  ...
  return (
    <div className="group relative bg-linear-to-br from-white/2 to-white/8 backdrop-blur-sm rounded-lg border border-white/10 hover:border-blue-400/50 hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-500 overflow-hidden flex flex-col">
      {/* Destello azul estilo Star Wars */}
      <div className="absolute inset-0 bg-linear-to-br from-blue-500/0 via-blue-400/0 to-cyan-500/0 group-hover:from-blue-500/20 group-hover:via-blue-400/15 group-hover:to-cyan-500/20 transition-all duration-500"></div>
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] text-white/40 uppercase tracking-wider">Project</span>
          </div>
        </div>
          ...
          <div className="flex flex-wrap gap-1.5 mb-3 sm:mb-4">
            ...
            {tech.length > 3 && (
              <div className="relative group/tech">
                ...
                {/* Tooltip */}
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 group-hover/tech:opacity-100 transition-opacity duration-200 pointer-events-none z-30">
