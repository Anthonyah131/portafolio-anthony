...
export default function CertificateCard({
  ...
  const CardContent = (
    <div className="h-full group relative bg-linear-to-br from-white/2 to-white/8 backdrop-blur-sm rounded-lg p-2.5 sm:p-3 md:p-4 border border-white/10 hover:border-purple-400/50 transition-all duration-300 overflow-hidden flex flex-col will-change-transform">
      ...
      <div className="relative flex flex-col gap-2 sm:gap-3 flex-1">
        ...
        <div className="flex items-start gap-2 sm:gap-3">
          {/* Icon */}
          <div className="shrink-0 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-linear-to-br from-purple-500/20 to-fuchsia-500/20 rounded-lg flex items-center justify-center border border-purple-400/30">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-300">{issuer}</p>
          </div>
        </div>
